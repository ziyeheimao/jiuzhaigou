  ...
  <section class="ctn">
    <header>
      ...
      <el-form :model="form" :rules="rules" ref="form" :label-width="labelWidth" class="listMattersAdminInput">
        <el-form-item label="窗口名称:" prop="">
          <el-input v-model="form.windwoName" style="width: 260px;" placeholder="请输入窗口名称"></el-input>
        </el-form-item>
      </el-form>
    </header>
    ...
    <main>
      ...
      <div class="bom">
        ...
        <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="a" label="窗口名称" width=''></el-table-column>
          <el-table-column prop="b" label="窗口位置" width=''></el-table-column>


          <el-table-column prop="c" label="窗口人员" width='120'>
            <template slot-scope="scope">
              <el-link slot="reference" type="primary" :underline="false">{{scope.row.c}}</el-link>
            </template>
          </el-table-column>
          <el-table-column prop="d" label="窗口事项" width='120'>
            <template slot-scope="scope">
              <el-link slot="reference" type="primary" :underline="false">{{scope.row.d}}</el-link>
            </template>
          </el-table-column>


          <el-table-column prop="e" label="窗口电话" width='150'></el-table-column>
          <el-table-column prop="f" label="创建时间" width='120'></el-table-column>
...
export default {
  ...
  data () {
    return {
      ...
      tableData: [
        {a: '2楼综合窗口', b: '政务中心2楼1-4号窗口', c: '6', d: '876', e: '0837-7732041', f: '2020-2-10'},
        {a: '2楼综合窗口', b: '政务中心2楼1-4号窗口', c: '6', d: '876', e: '0837-7732041', f: '2020-2-10'},
        {a: '2楼综合窗口', b: '政务中心2楼1-4号窗口', c: '6', d: '876', e: '0837-7732041', f: '2020-2-10'},
        {a: '2楼综合窗口', b: '政务中心2楼1-4号窗口', c: '6', d: '876', e: '0837-7732041', f: '2020-2-10'},
        {a: '2楼综合窗口', b: '政务中心2楼1-4号窗口', c: '6', d: '876', e: '0837-7732041', f: '2020-2-10'},
