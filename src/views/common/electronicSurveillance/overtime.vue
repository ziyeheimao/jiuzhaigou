      ...
      <el-form :model="form" :rules="rules" ref="form" :label-width="labelWidth" class="listMattersAdminInput">
        ...
        <div class="box">
          <el-form-item label="申请人:" prop="">
            <el-input v-model="form.code12"></el-input>
          </el-form-item>

          <el-form-item label="联系方式:" prop="">
            <el-input v-model="form.code123"></el-input>
          </el-form-item>
        </div>
      </el-form>
    </header>
    <main>
      ...
      <div class="bom">
        ...
        <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="a" label="事项编码"></el-table-column>
          <el-table-column prop="b" label="事项名称"></el-table-column>
          <el-table-column prop="c" label="事项类型"></el-table-column>
          <el-table-column prop="d" label="申请人"></el-table-column>
          <el-table-column prop="e" label="联系方式"></el-table-column>
          <el-table-column prop="f" label="所属部门"></el-table-column>
...
export default {
  ...
  data () {
    return {
      ...
      tableData: [
        {a: '512001041003', b: '教师资格证相关政策书面咨询', c: '草稿', d: '花卷', e: '13811881166', f: '九寨沟民政局', g: '2019-11-21 17:54:26'},
        {a: '512001041003', b: '教师资格证相关政策书面咨询', c: '草稿', d: '可乐', e: '13811881166', f: '九寨沟民政局', g: '2019-11-21 17:54:26'},
        {a: '512001041003', b: '教师资格证相关政策书面咨询', c: '草稿', d: '花卷', e: '13811881166', f: '九寨沟民政局', g: '2019-11-21 17:54:26'},
        {a: '512001041003', b: '教师资格证相关政策书面咨询', c: '草稿', d: '可乐', e: '13811881166', f: '九寨沟民政局', g: '2019-11-21 17:54:26'},
        {a: '512001041003', b: '教师资格证相关政策书面咨询', c: '草稿', d: '花卷', e: '13811881166', f: '九寨沟民政局', g: '2019-11-21 17:54:26'},
        {a: '512001041003', b: '教师资格证相关政策书面咨询', c: '草稿', d: '花卷', e: '13811881166', f: '九寨沟民政局', g: '2019-11-21 17:54:26'}
