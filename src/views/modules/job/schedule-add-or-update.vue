        ...
        this.$nextTick(() => {//用来延迟一段函数的执行
          ...
          if (this.dataForm.id) {
            this.$http({
              ...
              if (data && data.code === 0) {
                this.dataForm.beanName = data.bean.beanName
                this.dataForm.methodName = data.bean.methodName
                this.dataForm.params = data.bean.params
                this.dataForm.cronExpression = data.bean.cronExpression
