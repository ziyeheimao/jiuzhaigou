    ...
    methods: {
      init (id) {
        ...
        this.$http({
          ...
          this.menuList = treeDataTranslate(data.bean, 'menuId')
        }).then(() => {
          this.visible = true
          this.$nextTick(() => {
          ...
          if (!this.dataForm.id) {
            ...
            this.$http({
              ...
              this.dataForm.id = data.bean.menuId
              this.dataForm.type = data.bean.type
              this.dataForm.name = data.bean.name
              this.dataForm.parentId = data.bean.parentId
              this.dataForm.url = data.bean.url
              this.dataForm.perms = data.bean.perms
              this.dataForm.orderNum = data.bean.orderNum
              this.dataForm.icon = data.bean.icon
              this.menuListTreeSetCurrentNode()
            })
          }
        })
