<template>
  <section class="ctn">
    <header>
      ...
      <el-form :model="form" :rules="rules" ref="form" label-width="90px" class="listMattersAdminInput" :inline='true'>
        <el-form-item label="用户名:" prop="">
          <el-input style='width: 280px;' v-model="form.userName" placeholder="请输入用户名"></el-input>
        </el-form-item>

        <el-form-item label="姓名:" prop="">
          <el-input style='width: 280px;' v-model="form.name" placeholder="请输入姓名"></el-input>
        </el-form-item>

        <el-form-item label="手机号:" prop="">
          <el-input style='width: 280px;' v-model="form.phone" placeholder="请输入手机号"></el-input>
        </el-form-item>


        <el-form-item label="所属部门:" prop="">
          <el-select style='width: 280px;' v-model="form.department">
            <el-option v-for="(v,k) in res.industry" :key="k" :label="v.label" :value="v.value"></el-option>
          </el-select>
        </el-form-item>

        <el-form-item label="所属地区:" prop="">
          <el-select style='width: 280px;' v-model="form.industry">
            <el-option v-for="(v,k) in res.industry" :key="k" :label="v.label" :value="v.value"></el-option>
          </el-select>
        </el-form-item>
    ...
    <main>
      ...
      <div class="bom">
        ...
        <el-table ref="multipleTable" :data="tableData" tooltip-effect="dark" style="width: 100%" @selection-change="handleSelectionChange">
          ...
          <el-table-column prop="a" label="账户名"></el-table-column>
          <el-table-column prop="b" label="姓名"></el-table-column>
          <el-table-column prop="c" label="所属地区"></el-table-column>
          <el-table-column prop="d" label="所属部门"></el-table-column>
          <el-table-column prop="e" label="手机号"></el-table-column>
          <el-table-column prop="f" label="状态"></el-table-column><!-- :formatter='tableFilter' -->
...
export default {
  ...
  data () {
    return {
      ...
      tableData: [{a: 1, b: 2, c: 3, d: 4, e: 5, f: 6, g: 7}],
      // 批量状态处理
